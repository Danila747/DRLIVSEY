# Generated by Django 4.0.8 on 2023-02-05 05:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Обязательно для заполнения. От 3 до 32 букв.', max_length=32, unique=True, validators=[core.validators.MinLenValidator(field='username', min_len=core.enums.Limits['MIN_LEN_USERNAME']), core.validators.OneOfTwoValidator()], verbose_name='Уникальный юзернейм')),
                ('first_name', models.CharField(help_text='Обязательно для заполнения. Максимум 32 букв.', max_length=32, validators=[core.validators.OneOfTwoValidator()], verbose_name='Имя')),
                ('last_name', models.CharField(help_text='Обязательно для заполнения. Максимум 32 букв.', max_length=32, validators=[core.validators.OneOfTwoValidator], verbose_name='Фамилия')),
                ('password', models.CharField(help_text='Обязательно для заполнения. Максимум 32 букв.', max_length=32, verbose_name='Пароль')),
