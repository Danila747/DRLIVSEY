# Generated by Django 4.0.8 on 2023-02-04 13:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Обязательно для заполнения. От 3 до 150 букв.', max_length=150, unique=True, validators=[users.validators.MinLenValidator(min_len=core.enums.Limits['MIN_LEN_USERNAME']), users.validators.OneOfTwoValidator()], verbose_name='Уникальный юзернейм')),
